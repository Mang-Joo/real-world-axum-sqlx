...
pub async fn is_follow(follower_id: i64, following_id: i64, arc_app_state: ArcAppState) -> bool {
...
pub async fn save_follow(
    ...
    .map_err(|err| {
        error!(
            "Following error follower id is {} and following id is {} \n Error is {}",
...
mod test {
    ...
    async fn save_following_test() {
        ...
        let result = save_follow(1, 2, arc_app_state).await;
    ...
    async fn unfollow_success_test() {
        ...
        let result = unfollow(1, 2, arc_app_state).await;
